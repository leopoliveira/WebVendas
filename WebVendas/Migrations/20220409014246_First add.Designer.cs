...
namespace WebVendas.Migrations
{
    ...
    [Migration("20220409014246_First add")]
            ...
            modelBuilder.Entity("WebVendas.Models.Entities.SaleItem", b =>
                {
                    ...
                    b.Property<int>("SaleIdForeingKeySaleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SaleIdForeingKeySaleId");
            ...
            modelBuilder.Entity("WebVendas.Models.Entities.SaleItem", b =>
                {
                    ...
                    b.HasOne("WebVendas.Models.Entities.Sale", "SaleIdForeingKey")
                        .WithMany()
                        .HasForeignKey("SaleIdForeingKeySaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Product");

                    b.Navigation("SaleIdForeingKey");
                });
